/*
Este archivo reemplaza Waqi_servo.ino.

Este ejemplo realiza una consulta a OpenWeather: Cuál es la velocidad del viento en Madrid?

Si el valor es mayor a 9 el movimiento del servomotor es lento.
Si el valor es menor a 9 el movimiento del servomotor es muy rápido.

Circuito electrónico: https://coda.io/d/Open-Lab-Como-estas-mundo_dJ4ZNXIYYQk/Controlando-un-servomotor_sughR#_luS25
